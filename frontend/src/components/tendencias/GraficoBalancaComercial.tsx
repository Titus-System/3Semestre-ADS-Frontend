...
function formatarTitulo(estado?:string, pais?:string){
    let complemento = ``
    ...
    return `Balança Comercial: ${complemento}`
}


export default function GraficoBalancaComercial({ dados, estado, pais }: Props) {    
