export default function Footer(){
    return (
        <footer className="bg-[#0A0A37] p-4 mt-20">
          ...
          <div className="flex justify-between my-6 pl-8 pr-8">
            <div className="flex space-x-6">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-[#7D8491] hover:text-white">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-[#7D8491] hover:text-white">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div>
              <a href="https://github.com/Titus-System" target="_blank" rel="noopener noreferrer" className="text-[#7D8491] hover:text-white">
