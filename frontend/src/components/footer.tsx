...
export default function Footer(){
  return (
    <div className="relative z-0">
      ...
      <footer className="relative z-0 bg-transparent p-4 mt-20">
        
        <div className="relative z-0 w-full max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="flex flex-col">
              <div className="flex flex-row items-center gap-2 mb-4">
                <h1 className="text-xl font-bold text-[#7D8491]">Titus Systems</h1>
                <a href="https://github.com/Titus-System" target="_blank" rel="noopener noreferrer" className="text-[#7D8491] hover:text-white flex items-center group transition-colors duration-200">
                  <svg className="w-8 h-8 transform transition-transform duration-200 group-hover:scale-110 hover:scale-110" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Terceira coluna */}
            <div className="flex flex-col">
              <h1 className="text-xl font-bold text-[#7D8491] mb-4">Atalhos</h1>
