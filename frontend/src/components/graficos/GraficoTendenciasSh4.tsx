...
export default function GraficoTendenciasSh4({ sh4, estado, pais }: Props) {
    ...
    useEffect(() => {
        async function carregarDados() {
            setLoading(true);
            // const resultado = await buscarTendenciasSh4(sh4, estado, pais);
            const resultado = await buscarTendenciaDashboard(estado, pais, undefined, sh4);
            console.log("dadosBuscados sh4: ", resultado)
